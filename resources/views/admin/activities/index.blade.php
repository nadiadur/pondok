            ...
            <table class="table table-striped">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <img src="{{ Storage::url($activity->gambar) }}" alt="Gambar Kegiatan" width="50" class="rounded">
                        </td>
                        <td>
                            <a href="{{ route('admin.activities.edit', $activity) }}" class="btn btn-sm btn-warning">
                                <i class="fas fa-edit"></i>
                            </a>
                            <form action="{{ route('admin.activities.destroy', $activity) }}" method="POST" class="d-inline delete-form">
                                @csrf
                                @method('DELETE')
