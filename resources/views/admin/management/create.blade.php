...
<div class="card">
    <div class="card-header">
        <h5 class="mb-0">Tambah Pengurus Baru</h5>
    </div>
    <div class="card-body">
        <form action="{{ route('admin.management.store') }}" method="POST">
            ...
            <div class="mb-3">
                ...
                <input type="date" class="form-control" id="masa_aktif_mulai" name="masa_aktif_mulai" required>
            </div>

            <div class="mb-3">
                <label for="masa_aktif_selesai" class="form-label">Masa Aktif Selesai</label>
                <input type="date" class="form-control" id="masa_aktif_selesai" name="masa_aktif_selesai" required>
            </div>
