...
<div class="d-flex min-vh-100">
  ...
  <div class="flex-fill p-4 bg-light">
    ...
    <div class="row g-3">
      <div class="col-md-4"><div class="card text-center p-3"><i class="fas fa-user-tie fa-2x mb-2 text-primary"></i>Data Guru</div></div>
      <div class="col-md-4"><div class="card text-center p-3"><i class="fas fa-user-graduate fa-2x mb-2 text-success"></i>Data Santri</div></div>
      <div class="col-md-4"><div class="card text-center p-3"><i class="fas fa-calendar-alt fa-2x mb-2 text-info"></i>Data Kegiatan</div></div>
